         ...
         <div id="side-wrap">
    	  ...
    	  <div id="mid">
            ...
            <div id="header">
              ...
              <div id="topnav">
                <p><a href="#">Home</a> | <a href="member1.php">Members</a> | <a href="temp.php">Top Members</a> | <a href="about.html">About</a> | <a href="comm.php">post status</a> | <a href="login.php">sign Out</a></p></div>
...
$sql=mysql_query("select * from messages order by msg_id desc limit 0,3");
